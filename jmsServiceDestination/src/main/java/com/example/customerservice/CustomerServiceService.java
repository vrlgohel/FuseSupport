 ...
 * 2016-07-26T17:39:28.461+05:30
 * Generated source version: 3.0.4.redhat-621084
 * 
 */
@WebServiceClient(name = "CustomerServiceService", 
                  wsdlLocation = "file:/home/vgohel/Downloads/jmsServiceDestination/src/main/resources/wsdl/CustomerService.wsdl",
...
public class CustomerServiceService extends Service {
    ...
    static {
        URL url = null;
        try {
            url = new URL("file:/home/vgohel/Downloads/jmsServiceDestination/src/main/resources/wsdl/CustomerService.wsdl");
        } catch (MalformedURLException e) {
            java.util.logging.Logger.getLogger(CustomerServiceService.class.getName())
                .log(java.util.logging.Level.INFO, 
                     "Can not initialize the default wsdl from {0}", "file:/home/vgohel/Downloads/jmsServiceDestination/src/main/resources/wsdl/CustomerService.wsdl");
        }
        WSDL_LOCATION = url;
    }
